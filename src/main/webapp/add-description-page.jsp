...
<div class="container">
    <form action="/add-description" method="post">
        <h3 class="h3 mb-3 font-weight-normal"><fmt:message key="description.form"/></h3>
        ...
        <div>
            ...
            <input class="form-control" type="number" required="" id="cost" name="costPerNight"/>
        </div>
        <button class="btn btn-lg btn-primary btn-block" type="submit"><fmt:message key="admin.add.new.description"/></button>
    </form>
</div>
</body>
</html>
